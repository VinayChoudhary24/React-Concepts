...
//   // Our initial state Start with an "idle" status if query is falsy, as that means hook consumer is waiting on required data before creating the query object.
